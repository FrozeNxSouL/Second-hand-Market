    ...
    const inputNewValue = async () => {
        if (props >= bidInput) {
            ...
            try {
                ...
                setInputError(err.message || "Bid failed");
            }
        }
    }
    ...
    return (
        <>
            ...
            <dialog id="my_modal_2" className="modal" open>
                ...
                <form onSubmit={(e) => { e.preventDefault(); closeModal(); }} className="bg-black opacity-50 modal-backdrop">
                    <button>close</button>
                </form>
            </dialog>
            )}
